...
<head>
  ...
  <title>Contáctame - Gabriel Esteban Véliz Zúñiga</title>
...
<body>
  ...
  <div class="container-fluid contenedor2 conte4">
    ...
    <div class="col-11 col-md-8 formulario">
      ...
      <?php
        echo '<img class="ImgContact" src="data:image/jpeg;base64,'.base64_encode($resultImg).'"/> <br>';
        echo "<center><h4>".$resulNombre."</h4></center>";
      ?>
      
    <form action="contactar.php" method="post">
    <label for="exampleFormControlInput1">Nombre</label>
    <input id="ForTex1" name="nombre" type="text" class="form-control" placeholder="Nombre..." required="">
    <label for="exampleFormControlInput1">Correo Electronico</label>
    <input id="ForTex2" name="correo" type="email" class="form-control" placeholder="Nombre@ejemplo.com" required="">

    <label for="exampleFormControlTextarea1">Mensaje</label>
    <textarea id="ForTex3" name="mensaje" class="form-control" id="exampleFormControlTextarea1" rows="3" required=""></textarea>
    <br>
    <center>
    <input class="btn btn-primary" type="submit"  value="Enviar">
    <input id="borrar" class="btn btn-light" type="reset"  value="Borrar">
    </center>
    </form>
    </div>
