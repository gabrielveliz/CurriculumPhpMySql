  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="#"><i class="fa icon-home2"></i> <span>Administrar</span></a></li>
        <li><a href="#"><i class="fa icon-pencil"></i> <span>Inicio</span></a></li>
        <li><a href="#"><i class="fa icon-pencil"></i> <span>Curriculum</span></a></li>
        <li><a href="#"><i class="fa icon-pencil"></i> <span>GV</span></a></li>
        <li><a href="#"><i class="fa icon-pencil"></i> <span>Contacto</span></a></li>
        <li><a href="#"><i class="fa icon-user"></i> <span>Usuarios</span></a></li>
